...
export const ChoosePizzaForm: React.FC<Props> = ({
  ...
  return (
    <div className={cn(className, 'flex flex-col md:flex-row flex-1 h-full overflow-auto overflow-hidden')}>
      {/* Изображение пиццы */}
      <PizzaImage imageUrl={imageUrl} size={size} className="mb-5 md:mb-0 md:w-[240px] w-[50%] mx-auto" />
