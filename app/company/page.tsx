    ...
    <>
      ...
      <Container className="mt-10 pb-14">
        ...
        <blockquote className="italic text-gray-600">
          ...
          <p>
            Ножи СПБ — проверенная надёжность, как у старого друга. Мы не занимаемся маркетинговым трёпом, потому что наши ножи говорят сами за себя. У нас нет времени на лишние разговоры, мы просто делаем ножи, которые работают. И, как говорится в нашей компании Ножи СПБ, — "Если этот нож вас подвёл, то, скорее всего, вы просто делаете что-то не так."
          </p>
        </div>
      </Container>
    </>
